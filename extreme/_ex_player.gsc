...
suicideBomb(owner)
{
	...
	{
		explosion thread [[level.ex_devDamage]]("satchel", device_info, "kamikaze");
		level thread [[level.ex_devQueue]]("satchel", device_info);
	}
	else if(isWeaponType(self.ex_lastoffhand, "frag"))
	{
		explosion thread [[level.ex_devDamage]]("frag", device_info, "kamikaze");
		level thread [[level.ex_devQueue]]("frag", device_info);
	}
	else if(isWeaponType(self.ex_lastoffhand, "super"))
	{
		explosion thread [[level.ex_devDamage]]("supernade", device_info, "kamikaze");
		level thread [[level.ex_devQueue]]("supernade", device_info);
	}
